package com.sg.tmdbmovies.adapter;
...
import com.sg.tmdbmovies.databinding.MovieListItemBinding;
import com.sg.tmdbmovies.model.Movie;
import com.sg.tmdbmovies.view.MoviesInfo;
...
public class MoviesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    class MoviesViewHolder extends RecyclerView.ViewHolder {
        ...
        MoviesViewHolder(@NonNull final MovieListItemBinding movieListItemBinding) {
            ...
            this.movieListItemBinding.btnBookNow.setOnClickListener(v -> {
